...
<head>
  ...
  <!-- ✅ ใช้ฟอนต์ Prompt อย่างเดียว -->
  <link href="https://fonts.googleapis.com/css2?family=Prompt:wght@400;600;700&display=swap" rel="stylesheet">
  <style>
    /* ✅ ฟอนต์รวมทุก element */
    body, input, textarea, select, button, label, h1, h2, h3, h4, h5, h6 {
...
<body>
  <div class="form-card">
    <h2>⚠️ ยืนยันการลบคอร์ส</h2>
    <p>คุณแน่ใจหรือไม่ว่าต้องการลบคอร์ส <strong><?= htmlspecialchars($course['CourseName']) ?></strong> ?</p>
