...
<head>
  ...
  <style>
    ...
    h1 {
      ...
      color: #ff5733;
      margin-bottom: 30px;
      text-shadow: 0 0 10px rgba(255, 87, 51, .7);
    }
  ...
  <div class="container">
    ...
    <div class="card">
      ...
      <form method="post" enctype="multipart/form-data">
        <input type="text" name="title" class="form-control" placeholder="ชื่ออีเว้นท์" required>
        <div class="row">
          <div class="col-md-6">
        ...
        <textarea name="detail" class="form-control" placeholder="รายละเอียด" required></textarea>
        ...
        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
          <tr>
            ...
            <td>
              ...
              <a href="?delete=<?= $row['EventID'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('คุณแน่ใจหรือไม่ที่จะลบอีเว้นท์นี้?');"> ลบ </a>
            </td>
          </tr>
        <?php } ?>
      </tbody>
